...
| `server.image.tag`                                         | Vault Server image tag (immutable tags are recommended)                                                                                                 | `1.14.0-debian-11-r0` |
...
| `csiProvider.image.tag`                                                  | Vault CSI Provider image tag (immutable tags are recommended)                                                                                                 | `1.4.0-debian-11-r17`                         |
...
| `injector.image.tag`                                         | Vault Kubernetes Injector image tag (immutable tags are recommended)                                                                                                 | `1.2.1-debian-11-r23` |
