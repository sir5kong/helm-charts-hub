...
| `image.tag`                                   | Thanos image tag (immutable tags are recommended)                                                                   | `0.31.0-scratch-r7` |
...
| `compactor.cronJob.backoffLimit`                              | Specifies the number of retries before marking this job failed                                                                   | `""`                     |
