...
| `clusterOperator.image.repository`                                | RabbitMQ Cluster Operator image repository                                                                                               | `bitnami-mirror/rabbitmq-cluster-operator`      |
