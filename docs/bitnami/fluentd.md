...
```console
helm install my-release bitnami-mirror/fluentd
```
...
helm install my-release \
  --set aggregator.port=24444 bitnami-mirror/fluentd
```
...
```console
helm install my-release -f values.yaml bitnami-mirror/fluentd
```
