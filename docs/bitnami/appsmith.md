...
```console
helm install my-release bitnami/appsmith
```
...
| `image.tag`              | Appsmith image tag (immutable tags are recommended)                                                                                                 | `1.9.25-debian-11-r0` |
...
```console
helm install my-release -f values.yaml bitnami/appsmith
```
