...
| `alertmanager.image.tag`                                       | Alertmanager image tag (immutable tags are recommended)                                                                                                 | `0.25.0-debian-11-r62`          |
...
| `server.image.tag`                                                | Prometheus image tag (immutable tags are recommended)                                                                                                                                       | `2.45.0-debian-11-r0`      |
