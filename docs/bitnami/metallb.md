...
| `controller.image.repository`                                  | MetalLB Controller image repository                                                                                                         | `bitnami-mirror/metallb-controller` |
...
| `speaker.image.repository`                                  | MetalLB Speaker image repository                                                                                                            | `bitnami-mirror/metallb-speaker` |
